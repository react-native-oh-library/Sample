 ...
 function AppDetails() {
  ...
  return (
    <View style={styles.container}>
      <Animated.View style={[styles.textContainer, styles.box1, {opacity: opacityInterpolation}]}>
        <Text style={styles.apiFontSize}>容器1和文字由RN渲染</Text>
      </Animated.View>
      <Animated.View style={[styles.textContainer, styles.box2, {opacity: opacityInterpolation}]}>
      ...
      <Pressable 
        ...
        <Text style={{ height: 100, fontSize: 30, backgroundColor: '#B3DEE5', textAlign: 'center', textAlignVertical: 'center'}}>点击获取网络请求数据</Text>
      </Pressable>
    </View>
  );
};
