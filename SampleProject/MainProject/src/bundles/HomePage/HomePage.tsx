...
function App(): JSX.Element {
  ...
  const goods = [[good0, good0, good0], [good1, good1, good1], [good2, good2, good2]];  
    ...
    <View style={styles.container}>
      {/* <View style={styles.topButtonContainer}>
        {categories.map((category, index) => (
          ...
          key={index}
          label={category} 
          textStyle={{ fontSize: selectedIndex === index ? 26 : 20, fontWeight: selectedIndex === index ? 'bold' : 'normal' }}
          onPress={() => {
      ...
      <PagerView style={styles.pagerView} initialPage={1} ref={pagerRef} onPageSelected={onPageSelected}>
          {categories.map((category, index) => (
            <ScrollView contentInsetAdjustmentBehavior="automatic" style={styles.scrollView} key={index}>
